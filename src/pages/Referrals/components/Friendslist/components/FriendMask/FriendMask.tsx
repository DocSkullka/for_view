...
import styles from './friend-mask.module.scss';
...
export function FriendMask({ children, className, friendId, isLastItem }: Props) {
  return (
    <div className={styles.mask} id='friend' data-uid={isLastItem && friendId}>
      ...
      <svg width="273" height="64" viewBox="0 0 273 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <mask id="path-1-inside-1_13_3122" fill="white">
