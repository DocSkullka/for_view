...
import styles from './task-mask.module.scss';
...
export function TaskMask({ children, className, onClick }: Props) {
  return (
    <div className={styles.mask} onClick={onClick}>
      ...
      <svg width="273" height="64" viewBox="0 0 273 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <mask id="path-1-inside-1_12_2110" fill="white">
