...
//   const flatHeight = 1 // Фиксированное значение высоты для плоского рельефа
...
//   const heightmap = useTexture('/textures/heightmap_2048.png')
...
function createHeightfieldMatrix(image: HTMLImageElement): number[][] {
  ...
  const matrix: number[][] = Array(width)
  const row: number[] = Array(height)
  const scale = 70 // determines the vertical scale of the heightmap
  let p: number
